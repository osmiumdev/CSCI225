...
function onbtnclick() {
  ...
  var j = new eventObject(
    ...
    //could not find a way to pull the current user without returing null
    //decided to stay with self input
    testRSVPs,
    testComment);

  console.log(j);
  console.log(document.getElementById('sDate').value);
  addEventCallback(j, drawoncallback);
  retrieveAllEvents(drawCalendar);

}

function drawoncallback() {
